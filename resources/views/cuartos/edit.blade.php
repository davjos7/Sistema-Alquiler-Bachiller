    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{route('cuartos.update', $cuarto->id_cuarto)}}" method="post" class="row">
                    @csrf
                    @method('PUT')
                    <div class="col-md-6">
                            <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Nombre del Cuarto</label>
                            <input type="text" name="nombre_cuarto" value="{{ $cuarto->nombre_cuarto }}" class="form-control" aria-describedby="emailHelp">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Descripcion Del Cuarto</label>
                            <input type="text" name="descripcion_cuarto" value="{{ $cuarto->descripcion_cuarto }}" class="form-control" aria-describedby="emailHelp">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Precio del Cuarto</label>
                            <input type="number" name="precio_cuarto" value="{{ $cuarto->precio_cuarto }}" class="form-control" aria-describedby="emailHelp">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
