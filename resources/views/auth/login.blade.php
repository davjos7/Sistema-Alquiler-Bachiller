                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">Inicia Sesion</h5>
                                </div>
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" class="form-control" id="useremail" placeholder="Introduzca correo electrónico" :value="old('email')" required autofocus autocomplete="username" />
                        ...
                        <div class="mt-2 text-center">
                            <p class="">¿No tienes cuenta?<a href="{{ route('register') }}" class="fw-semibold text-primary text-decoration-underline"> Registrate </a> </p>
                        </div>
