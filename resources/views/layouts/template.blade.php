            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('cuartos.index') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('reservas.index') }}">
                                <i class="mdi mdi-puzzle-outline"></i> <span>Reservas</span>
                            </a>
                        </li>>
                    </ul>
                </div>
